source("./Functions/20190726.Functions.R")
...
saveRDS(all.models, file = paste0(data.folder, "Summary/20190726.All.Models.rds"))
saveRDS(all.forecasts, file = paste0(data.folder, "Summary/20190726.All.Forecasts.rds"))

summary(all.models %>% filter(bought.on > as.Date("2019-01-31")))
