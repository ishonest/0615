# 10% target ROI; Picking highest ROR
...
# Optimise Percentile Pick provided ROI >= 10%, ROR >= 4, Stop Loss Range: [1%, 5%]
...
saveRDS(hist.perf, paste0(data.folder, "Summary/20190808.Historical.Performance.rds"))
rm(stocks)
...
openxlsx::write.xlsx(list("T9.Summary" = T9.Summary), file = "./Reports/20190808 Type 9.xlsx")
...
saveRDS(prod.models, paste0(data.folder, "Summary/20190808.Production.Models.rds"))
