...
saveRDS(hist.perf, paste0(data.folder, "Summary/20190802.Historical.Performance.rds"))
rm(stocks)
...
openxlsx::write.xlsx(list("T9.Summary" = T9.Summary), file = "./Reports/20190802 Type 9.xlsx")
...
saveRDS(prod.models, paste0(data.folder, "Summary/20190802.Production.Models.rds"))
