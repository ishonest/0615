...
saveRDS(hist.perf, paste0(data.folder, "Summary/20190804.Historical.Performance.rds"))
rm(stocks)
...
openxlsx::write.xlsx(list("T9.Summary" = T9.Summary), file = "./Reports/20190804 Type 9.xlsx")
...
saveRDS(prod.models, paste0(data.folder, "Summary/20190804.Production.Models.rds"))
