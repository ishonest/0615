...
# Picking the most risky price to pick more stocks
# -------------------------------------------------------------------------
do.call(file.remove,
...
saveRDS(hist.perf, paste0(data.folder, "Summary/20190803.Historical.Performance.rds"))
rm(stocks)
...
openxlsx::write.xlsx(list("T9.Summary" = T9.Summary), file = "./Reports/20190803 Type 9.xlsx")
...
saveRDS(prod.models, paste0(data.folder, "Summary/20190803.Production.Models.rds"))
